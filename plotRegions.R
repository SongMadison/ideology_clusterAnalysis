...
load("/Users/karlrohe/Dropbox/code/npi/YALE/data/kmppi1000.RDATA")
# this loads csc$cluster, a label of the clusters from CASC. 
# the names are zipcodes. You can use any clustering you want... e.g. HRR.

loc = zipcode[names(csc$cluster),c("longitude", "latitude"), with= F]
